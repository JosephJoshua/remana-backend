...
func TestCreatePaymentMethodRequest_EncodeDecode(t *testing.T) {
	var typ CreatePaymentMethodRequest
	typ.SetFake()
	...
	var typ2 CreatePaymentMethodRequest
	require.NoError(t, typ2.Decode(jx.DecodeBytes(data)))
}
...
func TestCreatePhoneEquipmentRequest_EncodeDecode(t *testing.T) {
	var typ CreatePhoneEquipmentRequest
	typ.SetFake()
	...
	var typ2 CreatePhoneEquipmentRequest
	require.NoError(t, typ2.Decode(jx.DecodeBytes(data)))
}
...
func TestCreateRoleRequest_EncodeDecode(t *testing.T) {
	var typ CreateRoleRequest
	typ.SetFake()
